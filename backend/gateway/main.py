...
class Settings(BaseAppSettings):
    ...
    APPOINTMENTS_SERVICE_URL: str = "http://appointments-service:8003"
...
async def lifespan(app: FastAPI):
    ...
    print("✅ API Gateway started (Shared Config)")
    print("   Auth:          http://auth-service:8001")
    print("   Patients:      http://patients-service:8002")
    print("   Appointments:  http://appointments-service:8003")
    print("   Notifications: http://notifications-service:8004")
    yield
...
async def proxy(request: Request, path: str):
    ...
    headers.pop("content-length", None) # httpx recalculates content-length
