    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-5xl rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[620px] border border-gray-100">
                ...
                {/* ── Left Panel ─────────────────────── */}
                <div className="w-full md:w-[300px] shrink-0 bg-ortho text-white p-6 md:p-8 flex flex-col relative overflow-hidden">
                    {/* Decorative circles */}
                    <div className="absolute -top-16 -left-16 w-32 md:w-48 h-32 md:h-48 bg-white/5 rounded-full" />
                    <div className="absolute -bottom-20 -right-20 w-40 md:w-56 h-40 md:h-56 bg-white/5 rounded-full" />
                    ...
                    <div className="flex items-center gap-2 mb-6 md:mb-8">
                        {[1, 2, 3].map(i => (
                            <div key={i} className={clsx(
                                "h-1 md:h-1.5 flex-1 rounded-full transition-all duration-500",
                                        ...
                                        <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 gap-2">
                                            {availableSlots.map(time => (
                                                <button
                                                    ...
                                                    className={clsx(
                                                        "py-2 md:py-2.5 px-3 rounded-full text-xs md:text-sm font-semibold transition-all border text-center",
                                                        selectedTime === time
